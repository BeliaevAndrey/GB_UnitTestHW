...
class SomeServiceTest {
    ...
    @Test
    void testNullArrayFirstLast6() {
        assertFalse(service.firstLast6(null));
    }

    @Test
    void testEmptyArrayFirstLast6() {
        assertFalse(service.firstLast6(new int[0]));
    }
    ...
    @ParameterizedTest
    @CsvSource(value = {
            "13, 2, 3, 5",  "1, 2, 13, 3",  "1, 13, 3, 4",  "13, 2, 13, 2",
            "1, 13, 13, 1",  "13, 13, 3, 3",  "13, 13, 13, 0"})
    void checkSumThreeNumbersNegativeResultP(int a, int b, int c, int e) {
        assertEquals(e, service.calculatingSumThreeNumbers(a, b, c));
    }
}
